...
namespace SistemaGestaoPedidos.AcceptanceTests.Features.Steps
{
	...
	public class PedidoSteps
	{
		...
		private Pedidos _pedido = new Pedidos(new Cliente("Lucios Valter", "lucioll@teste.com"));
		...
		public void FazerUmPedido(string nome)
		{
			...
			_pedido = new Pedidos(_cliente);
		}

		[When(@"ele adiciona os seguintes itens ao pedido:")]
		public void ItensPedido(Table table)
		{
		...
		public void TotalDoPedido(decimal valorEsperado)
		{
